...
const ElectricalLights = () => {
    ...
    const { LIGHT_LANDING_ON, LIGHT_TAXI_ON, LIGHT_BEACON_ON, LIGHT_NAV_ON, LIGHT_STROBE_ON } = useSimConnectData().simConnectData;
    ...
    ), [classes, LIGHT_LANDING_ON, LIGHT_TAXI_ON, LIGHT_BEACON_ON, LIGHT_NAV_ON, LIGHT_STROBE_ON])
}
