...
const AutoPilotMaster = () => {
    ...
    const { AP_MASTER_ON, AP_FLIGHT_DIRECTOR_ON, AP_NAV_ON, AP_APPROACH_ON, AP_BACK_COURSE_ON, AP_VNAV_ON} = useSimConnectData().simConnectData;
    ...
    return useMemo(() => (
        <div className={classes.section}>
            <Grid container className={classes.autoPilot}>
                ...
                <SteppedLineTo from='NAV' to='VNV' fromAnchor="bottom" toAnchor="left" orientation="h" borderColor={lineColor} delay={true} within='NAV' />
            </Grid>
        </div>
    ), [classes, AP_MASTER_ON, AP_FLIGHT_DIRECTOR_ON, AP_NAV_ON, AP_APPROACH_ON, AP_BACK_COURSE_ON, AP_VNAV_ON])
}
