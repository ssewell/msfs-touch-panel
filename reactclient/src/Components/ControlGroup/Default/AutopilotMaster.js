...
const AutoPilotMaster = () => {
    ...
    const { AP_MASTER_ON, AP_FLIGHT_DIRECTOR_ON, AP_NAV_ON, AP_VNAV_ON, AP_APPROACH_ON, AP_BACK_COURSE_ON,
        AP_YAW_DAMPER_ON, AP_WING_LEVELER_ON, AP_AUTO_THROTTLE_ON } = useSimConnectData().simConnectData;
    ...
    return useMemo(() => (
        <div className={classes.section}>
            <Grid container className={classes.autoPilot}>
                ...
                <Grid item xs={2} className={classes.buttonBox}>
                    <Button variant="contained" size='small' className={'GPS'} color='primary' onClick={simActions.Autopilot.cdi}>GPS</Button>
                </Grid>
                <Grid item xs={2} className={classes.buttonBox}>
                ...
                <Grid item xs={4} className={classes.buttonBox}>
                    <Button variant="contained" size='small' className={'ATHR'} color='primary' style={{ backgroundColor: AP_AUTO_THROTTLE_ON ? onColor : '', minWidth: '7em' }} onClick={simActions.Autopilot.autoThrottle}>A/THR</Button>
                </Grid>
                <Grid item xs={2} className={classes.buttonBox}>
                ...
                <Grid item xs={2} className={classes.buttonBox}>
                    <Button variant="contained" size='small' className={'LVL'} color='primary' style={{ backgroundColor: AP_WING_LEVELER_ON ? onColor : '' }} onClick={simActions.Autopilot.leveler}>LVL</Button>
                </Grid>
    ...
    ), [classes, AP_MASTER_ON, AP_FLIGHT_DIRECTOR_ON, AP_NAV_ON, AP_VNAV_ON, AP_APPROACH_ON, AP_BACK_COURSE_ON,
        AP_YAW_DAMPER_ON, AP_WING_LEVELER_ON, AP_AUTO_THROTTLE_ON])
}
