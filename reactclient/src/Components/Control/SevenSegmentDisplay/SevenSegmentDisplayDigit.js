...
const SevenSegmentDisplayDigit = ({ fontSizeInEm, onColor, offColor, value }) => {
    const width = Number((fontSizeInEm / 2).toFixed(1));
    const height = Number((fontSizeInEm / 10).toFixed(1));
        ...
        return (
            <div
                style={{
                    ...
                    paddingTop: (fontSizeInEm + height * 2) + 'em'
                }}>
                <HSegment width={width / 8} height={height} color={onColor} />
            </div>
        )
    }
